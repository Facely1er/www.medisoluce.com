...
CRITICAL THREATS:
${report.threats.active.filter((t: any) => t.severity === 'critical').map((threat: any) => 
              ...
              {securityData.advanced?.threats?.active && securityData.advanced.threats.active.length > 0 && (
                <div>
                  ...
                  <div className="space-y-2">
                    {securityData.advanced.threats.active.slice(0, 3).map((threat: any, index: number) => (
              ...
              {securityData.advanced?.threats?.mitigated && securityData.advanced.threats.mitigated.length > 0 && (
                <div>
                  ...
                  <div className="space-y-1 max-h-24 overflow-y-auto">
                    {securityData.advanced.threats.mitigated.slice(0, 3).map((threat: any, index: number) => (
