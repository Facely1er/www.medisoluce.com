const enTranslation = {
  ...
  "home": {
    ...
    "hero_features": {
      ...
      "dependency_title": "Dependency Management", 
      "dependency_desc": "Map and secure critical technology systems",
      "continuity_title": "Business Continuity",
      "continuity_desc": "Ensure patient care remains uninterrupted"
    },
    "quick_access": {
      "title": "Quick Access",
    ...
    "healthcare_specific_desc": "Designed specifically for the unique compliance and technology challenges faced by healthcare organizations.",
    "integrated_approach": "Integrated Approach",
    "integrated_approach_desc": "The only platform that connects compliance requirements with the technology dependencies that support them.",
    "patient_safety": "Patient Safety Centered",
    "patient_safety_desc": "Prioritizes the impact of technology and compliance failures on patient care and safety.",
    "regulatory_alignment": "Regulatory Alignment",
    "regulatory_alignment_desc": "Built on the foundation of HIPAA, NIST, and other healthcare regulatory frameworks.",
    ...
    "journey_step_2": "Map Dependencies", 
    "journey_step_2_desc": "System Analysis",
    "journey_step_3": "Analyze Impact",
    "journey_step_3_desc": "Risk Assessment", 
    "journey_step_4": "Plan Continuity",
    "journey_step_4_desc": "Recovery Planning",
    "journey_training": "Staff Training & Certification",
    "journey_training_desc": "Build expertise with interactive training modules",
    "journey_toolkit": "Resource Toolkit",
    "journey_toolkit_desc": "Templates, policies, and implementation guides"
  },
  
  // Feature descriptions for homepage
  "features": {
    "hipaa_description": "Comprehensive self-assessment tools with scoring and recommendations aligned with HIPAA/HITECH requirements.",
    "dependency_description": "Map and visualize critical healthcare system dependencies to identify and mitigate technology risks.",
    "impact_description": "Assess the impact of technology failures on patient care and clinical operations.",
    "continuity_description": "Develop and maintain business continuity plans to ensure uninterrupted patient care."
  },
  ...
  "hipaa": {
    ...
    "your_score": "Your compliance score:"
  },

  "assessment_followup": {
    "saved_title": "Your results are saved in this browser",
    "saved_local_message": "This demo keeps your assessment on this device only. Nothing is sent to a server.",
    "saved_account_message": "Create a free account to access your results from any device and track your compliance progress over time.",
    "create_account": "Create Free Account",
    "sign_in": "Sign In",
    "email_title": "Email me this report",
    "email_help": "Opens your email app with the report attached as the message body. The address stays on your device — we do not collect it.",
    "email_placeholder": "you@organization.org",
    "email_submit": "Open email",
    "email_invalid": "Enter a valid email address.",
    "email_opened": "Your email app should open with the report. If nothing happened, download the report instead.",
    "email_subject": "HIPAA assessment report ({{score}}%)",
    "email_body": "HIPAA compliance score: {{score}}% ({{points}})\n\nRecommendations:\n{{recommendations}}\n\nGenerated by MediSoluce. Results remain in your browser unless you choose to save them elsewhere.",
    "no_recommendations": "None recorded.",
    "next_step_title": "Recommended next step",
    "next_step_cta": "Continue to Step 2: Map Your Systems",
    "handoff_low": "Your assessment found significant compliance gaps. Mapping system dependencies next shows where patient data is most exposed if a system fails.",
    "handoff_mid": "You have a solid foundation. Map your systems next so you can see which technology dependencies still need stronger HIPAA safeguards.",
    "handoff_high": "Strong score. Map your systems next to keep PHI pathways documented as your environment changes."
  },
  
  // Dependency Manager page
  "dependency": {
    "title": "Technology Dependency Management",
    "subtitle": "Map, visualize, and secure your critical healthcare technology dependencies to ensure patient care resilience.",
    "get_started": "Get Started",
    "watch_demo": "Watch Demo",
    "ecosystem": "Healthcare Technology Ecosystem",
    "how_works": "How Our Dependency Manager Works",
    "map_ecosystem": "Map Your Healthcare Technology Ecosystem",
    "map_subtitle": "MediSoluce supports comprehensive dependency mapping across all healthcare technology categories.",
    "ready_map": "Ready to map your healthcare technology dependencies?",
    "ready_map_subtitle": "Get started with our free assessment tool and visualize your organization's technology ecosystem.",
    "start_free": "Start Free Dependency Map",
    "system_categories": {
      "ehr": "EHR Systems",
      ...
      "mobile": "Mobile & Telehealth",
      "examples": {
        "ehr": "Epic, Cerner, Meditech, Allscripts",
        "clinical": "PACS, LIS, Pharmacy, Oncology",
        "infrastructure": "Servers, Storage, Network, Virtualization",
        "medical_devices": "Infusion Pumps, Monitoring, Imaging, Ventilators",
        "client_devices": "Workstations, Laptops, Tablets, Thin Clients",
        "mobile": "Mobile Apps, Telehealth Platforms, Remote Monitoring"
      }
    }
  },
  ...
  "continuity": {
    ...
    "subtitle": "Ensure uninterrupted patient care with comprehensive business continuity and disaster recovery planning.",
    ...
    "ready_strengthen": "Ready to strengthen your continuity planning?",
    "start_planning": "Start Planning",
    "cta_description": "Start creating comprehensive continuity plans for your healthcare organization.",
    "risk_categories": {
      "natural_disasters": "Natural Disasters",
      "technology_failures": "Technology Failures",
      "cyber_security_incidents": "Cyber Security Incidents",
      "power_outages": "Power Outages",
      "staff_shortages": "Staff Shortages",
    ...
    "manager": {
      "title": "Continuity Plan Manager",
      "subtitle": "Create and manage business continuity plans for your healthcare organization",
      "back_to_overview": "Back to Overview",
      "edit_plan": "Edit Continuity Plan",
      "create_plan": "Create Continuity Plan",
      "form": {
        "plan_name": "Plan Name *",
        "plan_name_placeholder": "e.g., EHR System Outage Plan",
        "risk_category": "Risk Category",
        "risk_category_select": "Select Risk Category",
        "impact_level": "Impact Level",
        "recovery_time_objective": "Recovery Time Objective (RTO)",
        "recovery_time_objective_placeholder": "e.g., 4 hours, 24 hours",
        "recovery_point_objective": "Recovery Point Objective (RPO)",
        "recovery_point_objective_placeholder": "e.g., 1 hour, 8 hours",
        "responsible_party": "Responsible Party",
        "responsible_party_placeholder": "e.g., IT Director, Facilities Manager",
        "testing_schedule": "Testing Schedule",
        "testing_schedule_placeholder": "e.g., Quarterly, Annually",
        "last_tested": "Last Tested",
        "plan_description": "Plan Description",
        "plan_description_placeholder": "Brief description of this continuity plan...",
        "recovery_procedures": "Recovery Procedures",
        "recovery_procedures_placeholder": "Detailed step-by-step recovery procedures..."
      }
    },
    "modal": {
      "delete_title": "Confirm Deletion",
      "delete_message": "Are you sure you want to delete this continuity plan? This action cannot be undone.",
      "cancel": "Cancel",
      "delete": "Delete"
    },
    "table": {
      ...
      "delete": "Delete",
      "download": "Download",
      "no_plans": "No continuity plans created yet",
      "create_first": "Create your first continuity plan"
    },
    "template": {
      "title": "BUSINESS CONTINUITY PLAN TEMPLATE",
      "organization": "Organization: [Your Organization Name]",
      "plan_type": "Plan Type: [Risk Category]",
      "created": "Created:",
      "executive_summary": "EXECUTIVE SUMMARY",
      "purpose": "Purpose: [Describe the purpose of this continuity plan]",
      "scope": "Scope: [Define what this plan covers]",
      "authority": "Authority: [Who has authority to activate this plan]",
      "plan_activation": "PLAN ACTIVATION",
      "activation_triggers": "Activation Triggers:",
      "activation_authority": "Activation Authority:",
      "primary": "Primary: [Name and contact]",
      "secondary": "Secondary: [Name and contact]",
      "recovery_procedures": "RECOVERY PROCEDURES",
      "phase_1": "Phase 1: Immediate Response (0-4 hours)",
      "phase_2": "Phase 2: Short-term Recovery (4-72 hours)",
      "phase_3": "Phase 3: Long-term Recovery (72+ hours)",
      "communication_plan": "COMMUNICATION PLAN",
      "internal_communications": "Internal Communications:",
      "external_communications": "External Communications:",
      "testing_and_training": "TESTING AND TRAINING",
      "testing_schedule": "Testing Schedule:",
      "training_requirements": "Training Requirements:",
      "approval": "APPROVAL",
      "plan_approved_by": "Plan Approved By: _________________ Date: _________",
      "next_review_date": "Next Review Date: _________________",
      "generated_by": "Generated by MediSoluce Healthcare Compliance Platform"
    }
  },
  ...
  "ransomware": {
    ...
    "response": "Response",
    "recovery": "Recovery",
    "incident_response": "Incident Response Process",
  ...
  "ransomware_resilience": {
    ...
    "stat_1_value": "Major Incident",
    "stat_1_description": "Vendor breaches affect millions (e.g., Change Healthcare)",
    "stat_1_note": "Source: Public breach notifications, 2024.",
    "stat_2_value": "Sustained",
    "stat_2_description": "Constant attack pressure on healthcare organizations",
    "stat_2_note": "Source: Industry threat intelligence.",
    "stat_3_value": "Multiple",
    ...
    "pricing_note": "Market rates are estimated based on typical consulting and implementation services. MediSoluce pricing reflects our commitment to healthcare affordability. Actual costs vary based on organizational size and requirements."
  },
  ...
  // Toolkit page
  "toolkit": {
    "title": "Healthcare Compliance Toolkit",
    "subtitle": "Download templates, policies, procedures, and guides to support your healthcare compliance and technology resilience programs.",
    "search": "Search resources...",
    "clear_filter": "Clear Filter",
    "no_resources": "No resources found matching your search criteria.",
  ...
  "contact": {
    ...
    "phone": "Phone",
    "phone_desc": "Monday to Friday 9am to 5pm EST",
    "email": "Email",
    "email_desc": "We'll respond within 24 hours",
    "office": "Office",
    "office_desc": "Come visit us",
    "send_message": "Send us a message",
    "send_message_desc": "Fill out the form below and we'll get back to you as soon as possible.",
    "name": "Name",
    "phone_field": "Phone",
  ...
  "thanks": {
    ...
    "subtitle": "We've received your message and will get back to you within 24 hours.",
    "check_email": "Check Your Email",
    "check_email_desc": "We've sent you a confirmation email with additional information.",
    "explore_resources": "Explore Resources",
    "explore_resources_desc": "Browse our compliance toolkit while you wait for our response.",
    "schedule_demo": "Schedule a Demo",
    "schedule_demo_desc": "Book a personalized demo of our healthcare compliance platform.",
  ...
  "cookies": {
    ...
    "types_we_use": "Types of Cookies We Use",
    "your_choices": "Your Cookie Choices",
  ...
  "profile": {
    ...
    "show_guidance": "Show Guidance by Default",
    ...
    "email_cannot_change": "Email cannot be changed for security reasons"
  },
...
// Advanced assessment translations (referenced in translationHelpers.ts)
"assessment": {
...
// Demo page (missing from original en.ts)
"demo": {
  "title": "Interactive Platform Demo",
  "subtitle": "Discover the full capabilities of MediSoluce with this interactive demonstration.",
  "play": "Play",
  "pause": "Pause",
  "next": "Next", 
  "previous": "Previous",
  ...
  "hipaa_assessment": {
    ...
    "questions": {
      "risk_assessment": {
        ...
        "options": {
          "yes_comprehensive": "Yes, we have conducted a comprehensive assessment that covers all systems and processes",
          "yes_partial": "Yes, but it was limited in scope or did not cover all systems",
          "no_planned": "No, but we have one planned",
          "no": "No, we have not conducted a risk assessment"
        }
      },
      "policies_procedures": {
        ...
        "options": {
          "yes_comprehensive": "Yes, comprehensive and regularly updated",
          "yes_outdated": "Yes, but they need updating",
          "partial": "We have some, but not all required policies"
        }
      },
      "employee_training": {
      ...
      "encryption": {
        ...
        "options": {
          "both": "Yes, both at rest and in transit"
        }
      },
      "access_controls": {
        ...
        "options": {
          "rbac_audit": "Role-based access with regular auditing and certification",
          "rbac": "Role-based access controls without regular review",
          "basic": "Basic username/password controls"
        }
      },
      "business_associates": {
        ...
        "options": {
          "all_reviewed": "Yes, with all vendors and regularly reviewed",
          "all": "Yes, with all vendors"
        }
      },
      "incident_response": {
        ...
        "options": {
          "tested": "Yes, documented and regularly tested",
          "documented": "Yes, documented but not tested"
        }
      },
      "audit_logs": {
        ...
        "options": {
          "comprehensive_monitored": "Yes, comprehensive logs with active monitoring",
          "comprehensive": "Yes, comprehensive logs without active monitoring"
        }
      },
      "device_security": {
        ...
        "options": {
          "mdm_encryption": "MDM solution with encryption, remote wipe, and device policies",
          "basic": "Basic security measures (passwords only)"
        }
      },
      "emergency_access": {
        ...
        "options": {
          "documented_tested": "Yes, documented and regularly tested",
          "documented": "Yes, documented but not tested"
        }
      }
    },
