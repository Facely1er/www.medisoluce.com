...
2. [Activation Procedures](#activation-procedures)
3. [Clinical Procedures](#clinical-procedures)
...
**Impact:** Single module or limited functionality affected  
**Examples:** Lab interface down, scheduling system unavailable  
**Response:** Workaround procedures, minimal workflow disruption

### Level 2: Major System Downtime (Moderate Impact)
**Duration:** 2-8 hours expected  
