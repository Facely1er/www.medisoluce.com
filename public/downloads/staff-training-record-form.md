...
2. **File in personnel records** and maintain for at least 6 years
3. **Update annually** or when significant policy changes occur
4. **Use for compliance audits** and regulatory reviews
5. **Track completion dates** to ensure timely refresher training
